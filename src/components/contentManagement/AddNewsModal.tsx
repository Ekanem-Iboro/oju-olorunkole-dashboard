...
import { useAddNews, useUploadImage } from '../../../api/mutate';
...
export function AddNewsModal({ isOpen, onClose }: AddNewsModalProps) {
    ...
    const { mutate: addNews, isPending: isAdding } = useAddNews();
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4" onClick={handleClose}>
            ...
            >
                <div className="flex items-center justify-between p-6 border-b border-[#E2E8F0]">
                    <h3 className="text-xl font-semibold text-[#374151]">Add News Article</h3>
                    <button
                        onClick={handleClose}
                        disabled={isLoading}
                ...
                <form onSubmit={handleSubmit(handleFormSubmit)} className="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <p className="text-[#6B7280] text-xs mt-1">Optional. Supported formats: JPG, PNG, GIF (Max 5MB)</p>
                    </div>
                    ...
                    <div className="flex justify-end space-x-3 pt-4 border-t border-[#E2E8F0]">
                        ...
                        >
                            {isAdding && <div className="animate-spin rounded-full h-4 w-4 border-b-2 border-white"></div>}
                            <span>{isAdding ? 'Creating...' : 'Create News'}</span>
                        </button>
                    </div>
                </form>
            </div>
